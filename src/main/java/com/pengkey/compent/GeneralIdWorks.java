...
public class GeneralIdWorks {
    ...
    private final static long beginTs = new Date().getTime();
    ...
    public static void main(String[] args) throws Exception {
        ...
        GeneralIdWorks ig = new GeneralIdWorks();
